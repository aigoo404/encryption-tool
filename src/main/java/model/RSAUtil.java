...
public class RSAUtil {
    ...
    public static void encryptFile(String inputFilePath, String outputFilePath, String publicKeyString)
            throws Exception {
        PublicKey publicKey = loadPublicKey(publicKeyString);
        encryptFile(inputFilePath, outputFilePath, publicKey);
    }

    public static void decryptFile(String inputFilePath, String outputFilePath, PrivateKey privateKey)
            throws Exception {
        Cipher cipher = Cipher.getInstance(TRANSFORMATION);
        cipher.init(Cipher.DECRYPT_MODE, privateKey);
    ...
    public static void decryptFile(String inputFilePath, String outputFilePath, String privateKeyString)
            throws Exception {
        PrivateKey privateKey = loadPrivateKey(privateKeyString);
