...
public class digitalSignature {
    ...
    public static boolean verifyFile(String filePath, String signatureString, String publicKeyString, boolean isAlreadyHashed) throws Exception {
        byte[] fileData = Files.readAllBytes(Paths.get(filePath));
        if (isAlreadyHashed) {
    ...
    public static boolean verifyFile(String hashedFilePath, String signatureString, PublicKey publicKey) throws Exception {
        byte[] hashedData = Files.readAllBytes(Paths.get(hashedFilePath));
        return verifyRawHash(hashedData, signatureString, publicKey);
    }
    
    public static boolean verifyFile(String hashedFilePath, String signatureString, String publicKeyString) throws Exception {
        byte[] hashedData = Files.readAllBytes(Paths.get(hashedFilePath));
